const Homolobus_infumator =    [1,2,2,1,1,2,2]

const Homolobus_annulicornis = [1,2,2,2,1,2,1]

const Homolobus_discolor =     [2,1,2,2,1,2,0]

const Homolobus_bohemani =     [1,0,1,2,1,0,0]

const Homolobus_flagitator =   [1,1,2,2,1,0,0]

const Homolobus_truncator =    [1,2,2,2,2,1,0]
